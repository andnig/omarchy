...
ln -snf ~/.config/omarchy/current/theme/backgrounds/3-scenery-pink-lakeside-sunset-lake-landscape-scenic-panorama-7680x3215-144.png ~/.config/omarchy/current/background
